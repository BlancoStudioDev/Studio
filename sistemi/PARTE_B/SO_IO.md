...
Domanda:
La gestione delle periferiche in un sistema di elaborazione monoprocessore: si descriva
l’organizzazione del software di sistema per la loro gestione e le principali funzioni che esso deve
realizzare, evidenziandone caratteristiche, vantaggi e limiti.
...
* Accesso Diretto alla memoria (DMA)
	* Permette di mandare direttamente di dati dal dispositivo alla memoria, per esempio per la conne		ssione di un hard disk esterno, i dati possono esser mandati direttamente alla memoria sen		 za dover passare prima da qualche altro controller o dispositivo di altro tipo. <D-T><D-T>
